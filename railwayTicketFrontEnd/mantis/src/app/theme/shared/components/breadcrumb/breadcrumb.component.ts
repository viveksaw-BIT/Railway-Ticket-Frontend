...
// project import
import { NavigationItem, NavigationItems, UserNavigationItems, CombinedNavigationItems } from 'src/app/theme/layouts/admin-layout/navigation/navigation';
...
export class BreadcrumbComponent {
  ...
  constructor(
    ...
    this.navigations = CombinedNavigationItems;
    this.type = 'theme1';
    this.setBreadcrumb();
